...
<html lang="en" with-selection-styled>
  <head>
    ...
    <meta name="twitter:url" content="https://web.Spider.workers.dev">
  ...
  <body>
    <div class="Surface">
      <div class="Panel">
        <div class="Panel--top">
          <h1><a href="https://web.Spider.workers.dev" class="Link Link-without-underline"><span class="WebScraperLogo"><span>web.Spider</span><span class="WebScraperLogo--muted">.workers.dev</span></span></a></h1>
        ...
        <main class="Panel--main" is-smooth-scrolling>
          <form id="form" class="Stack" method="GET" action="https://web.Spider.workers.dev">
            <div class="FormField">
        ...
        <div class="Panel--bottom">
          <div class="Row">
            ...
            <a data-js-permalink href="https://web.Spider.workers.dev" class="Button Button-is-bordered" type="button">Permalink</a>
          </div>
        </div>
      </div>

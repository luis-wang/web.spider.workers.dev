...
<html lang="en" with-selection-styled>
  ...
  <body>
    <div class="Surface">
      <div class="Panel">
        <div class="Panel--top">
          <h1><a href="https://web-spider.backtothe2035.workers.dev/" class="Link Link-without-underline"><span class="WebScraperLogo"><span>web.spider</span><span class="WebScraperLogo--muted">.workers.dev</span></span></a></h1>
          ...
          <form id="form" class="Stack" method="GET" action="https://web.scraper.workers.dev">
            <div class="FormField">
              <div class="FormField--text">
                <label class="FormField--label" for="url">网址</label>
              </div>
            ...
            <div class="FormField">
              <div class="Radio---list">
                <div class="Radio">
                  ...
                  <label class="Radio--label" for="scrape-text">显示匹配的节点内容（如p, a）</label>
                </div>
                <div class="Radio">
                  <input class="Radio--input" type="radio" name="scrape" id="scrape-attr" value="attr"/>
                  <label class="Radio--label" for="scrape-attr">显示最后节点的属性内容</label>
                </div>
              </div>
            </div>
            ...
            <div class="FormField" show-if-scrape="attr" is-hidden>
              <div class="FormField--text">
                <label class="FormField--label" for="selector">属性</label>
              </div>
